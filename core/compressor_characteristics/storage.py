    ...
    def __init__(self, extend: float=0.2, grid_pnt_num: int=50):
        ...
        self.branches = [
            FrequencyBranch(
                ...
                G_rel=[0.345, 0.33, 0.32, 0.315, 0.3],
            ...
            FrequencyBranch(
                ...
                G_rel=[0.467, 0.457, 0.454, 0.450, 0.442, 0.435],
            ...
            FrequencyBranch(
                ...
                G_rel=[0.603, 0.5985, 0.5975, 0.5970, 0.594, 0.591, 0.58, 0.56],
            ...
            FrequencyBranch(
                ...
                G_rel=[0.925, 0.922, 0.917, 0.913, 0.909, 0.904, 0.902, 0.898, 0.895, 0.89, 0.875],
            ...
            FrequencyBranch(
                ...
                G_rel=[1.019, 1.016, 1.013, 1.011, 1.009, 1.005, 1.002, 0.998, 0.991, 0.985, 0.978],
            ...
            FrequencyBranch(
                ...
                G_rel=[1.135, 1.1325, 1.1295, 1.125, 1.117, 1.105],
